...
playsound minecraft:music_disc.ward master @s ~ ~ ~ 5 2 1

schedule function willpvp2:kit/clown/stop_intro_music 4s replace
...
give @s minecraft:iron_hoe{Enchantments:[{id:sharpness,lvl:3}],display:{Name:"\"Knife to meet you\""},Unbreakable:1}
