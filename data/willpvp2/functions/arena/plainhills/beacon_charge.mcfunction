playsound minecraft:block.large_amethyst_bud.break master @a 0 7 0 2 1 0
...
execute if block 0 7 0 orange_wool run function willpvp2:arena/plainhills/blessing_charge
execute if block 0 7 0 lime_wool run function willpvp2:arenna/plainhills/blessing

execute unless block 0 7 0 glass run schedule function willpvp2:arena/plainhills/beacon_charge 2s replace
